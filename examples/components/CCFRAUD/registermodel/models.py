# NOTE: This file is identical to the ../traininsilo/models.py.
#       It is required to create a valid instance of the model architecture!
#       Any change in the model architecture in the traininsilo component should be replicated here.
